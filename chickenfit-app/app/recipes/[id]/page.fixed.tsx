    ...
    if (accessToken) {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(data.error?.message || "Không thể thêm vào nhật ký");
        }
      } catch (err) {
        ...
        setIsAdding(false);
        // Reset success message after 2.5s
        if (added) {
      ...
      <div style={{ padding: "0 16px 32px" }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 14, fontSize: 15, fontWeight: 700, cursor: isAdding || added ? "not-allowed" : "pointer",
            border: "none",
            background: added ? "#4A7C59" : (isAdding ? "#999" : "#4A7C59"),
